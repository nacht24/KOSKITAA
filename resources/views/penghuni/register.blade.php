...
@section('title', 'Daftar Penghuni Baru - KOSKITAA')
...
<div class="min-h-screen flex items-center justify-center bg-gray-100 px-4">
    <div class="bg-white p-10 rounded-3xl shadow-xl w-full max-w-md border border-gray-100">
        ...
        <form action="{{ route('penghuni.register.submit') }}" method="POST" class="space-y-5">
            ...
            <div class="pt-2">
                <button type="submit" class="w-full bg-blue-600 text-white py-3.5 rounded-xl font-bold hover:bg-blue-700 shadow-md hover:shadow-lg active:scale-[0.98] transition-all text-sm tracking-wide">
                    Daftar Sekarang
                </button>
            </div>
